...
import 'package:pollingweb/UpdateMp.dart';
...
class _MPdetailsState extends State<MPdetails> {
  ...
  Widget build(BuildContext context) {
   ...
   return new Scaffold(
appBar: AppBar(title: Text("MP Details", textAlign:TextAlign.center),
              ...
              itemBuilder: (context, index){
                return ListTile(
                 ...
                 Card(
                   ...
                   SizedBox(height:20),
                   Divider(),
                   Text("E-Mail: "+snapshot.data.documents[index]['E-mail'],style: TextStyle(fontSize: 20.0, color: Colors.black, )),
                  SizedBox(height:20),

                   Divider(),
                   Text("Contact: "+snapshot.data.documents[index]['Contact'].toString(),style: TextStyle(fontSize: 20.0, color: Colors.black)),
                    SizedBox(height:20),
 Divider(),
                   Text("Party: "+snapshot.data.documents[index]['party'],style: TextStyle(fontSize: 20.0, color: Colors.black)),
                    SizedBox(height:20),
                   Divider(),
                   
                   Text("Constituency: "+snapshot.data.documents[index]['Constituency'],style: TextStyle(fontSize: 20.0, color: Colors.black,)),
                     SizedBox(height:20),

                   Divider(),
                   Text("Address: "+snapshot.data.documents[index]['Address'],style: TextStyle(fontSize: 20.0, color: Colors.black)),
                   SizedBox(height:20),
                   Divider(),
                     FlatButton.icon(
    ...
    context,
    MaterialPageRoute(builder: (context) =>ProjectDetails(id:widget.id)),
  );  } ),
           FlatButton.icon(
           icon: Icon(Icons.update),
           label: Text("Update Mp Details",style: TextStyle(fontSize: 20.0, color: Colors.black)),
           onPressed: (){Navigator.push(
    context,
    MaterialPageRoute(builder: (context) =>UpdateMp(id:widget.id)),
  ); } )
                 ],))
                 ); }
             );
