...
import 'package:pollingweb/Auth.dart';
...
class _LoginPageState extends State<LoginPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
       appBar: AppBar(title: Text("POLLING SYSTEM", textAlign:TextAlign.center),
        backgroundColor: Colors.green,),
        body: Container(
         
            child:
           GridView(
             padding: EdgeInsets.fromLTRB(35, 105, 35,20),
          gridDelegate: new SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 3, mainAxisSpacing: 2.0,crossAxisSpacing: 2.0,  childAspectRatio: 1.5, ),
  ...
  child:   
        Card(
            color:Colors.green, 
             child:
             Center(
              child:  Text("ADMIN PANNEL", style: TextStyle(fontSize: 20.0,color: Colors.white,  fontWeight: FontWeight.bold, ),textAlign: TextAlign.center,
                ),
 ...
 color:Colors.green,
                  ...
                  SizedBox(height:10 ), 
                      ...
                      Text("ADMIN PANNEL",style: TextStyle(fontWeight:FontWeight.w900,fontSize: 30,color: Colors.white),),
                      SizedBox(
                        width:500,
                    child:Form(
                        key: formKey,
